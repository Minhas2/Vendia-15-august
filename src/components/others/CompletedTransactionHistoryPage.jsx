...
export default function CompletedTransactionHistoryPage() {
...
{isMobile ? (
  ...
  <div onClick={handleClick2} style={{width: 115, height: 48, paddingLeft: 24, paddingRight: 24, paddingTop: 21, paddingBottom: 21,background: '#F62EFF', borderRadius: 100, border: '1px white solid', justifyContent: 'center', alignItems: 'center', gap: 2, display: 'flex'}}>
  ...
  <div  onClick={handleClick2} style={{flex: '1 1 0', height: 48, paddingLeft: 24, paddingRight: 24, paddingTop: 21, paddingBottom: 21, background: '#F62EFF', borderRadius: 100, border: '1px white solid', justifyContent: 'center', alignItems: 'center', gap: 16, display: 'flex'}}>
