...
{isMobile ? (
 ...
 <div style={{width: "90%", height: 48, justifyContent: 'flex-start', alignItems: 'center', gap: 1, display: 'inline-flex'}}>


<button onClick={handleClick1} style={{width: "90%", height: 48, paddingLeft: 24, paddingRight: 24, paddingTop: 21, paddingBottom: 21, background: '#F62EFF', borderRadius: 100, border: '1px white solid', justifyContent: 'center', alignItems: 'center', gap: 2, display: 'flex', margin:"2%"}}>

<div style={{textAlign: 'center', color: 'white', fontSize: 12, fontFamily: 'Outfit', fontWeight: '700',  letterSpacing: 0.30, wordWrap: 'break-word'}}>CashOut Now</div>
</button>


<div  onClick={handleClick2} style={{width: "90%", height: 48, paddingLeft: 24, paddingRight: 24, paddingTop: 21, paddingBottom: 21, background: '#4113A0', borderRadius: 100, border: '1px white solid', justifyContent: 'center', alignItems: 'center', gap: 2, display: 'flex', margin:"2%"}}>

<div style={{textAlign: 'center', color: 'white', fontSize: 12, fontFamily: 'Outfit', fontWeight: '700',  letterSpacing: 0.30, wordWrap: 'break-word'}}>Cashout History</div>
</div>
  ...
  <div style={{width: "100%", height: 48, justifyContent: 'flex-start', alignItems: 'center', gap: 12, display: 'inline-flex', marginTop:"30px"}}>
  ...
  <div style={{textAlign: 'center', color: 'white', fontSize: 18, fontFamily: 'Outfit', fontWeight: '700', lineHeight: 27, letterSpacing: 0.30, wordWrap: 'break-word'}}>CashOut Now</div>
  </div>
  ...
  <div style={{textAlign: 'center', color: 'white', fontSize: 18, fontFamily: 'Outfit', fontWeight: '700', lineHeight: 27, letterSpacing: 0.30, wordWrap: 'break-word'}}>CashOut History</div>
  </div>
...
<div style={{width: 327, height: 488, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 24, display: 'inline-flex', marginTop:"20px", marginBottom:"50px"}}>
...
<div style={styles.container}>
      <div style={styles.innerContainer}>
        ...
        <div style={styles.cardContainer}>
          ...
          <div style={{ ...styles.card, background: 'rgba(217, 217, 217, 0)' }}>
            <div style={styles.cardText}>
              USDT<br/>
        ...
        <div style={styles.inputContainer}>
          <div style={styles.inputTextContainer}>
            <div style={styles.inputLabelText}>Cashout Amount</div>
            <div style={styles.inputPlaceholderText}>Cashout Amount</div>
          </div>
        </div>
        <div style={styles.inputContainer}>
          <div style={styles.inputTextContainer}>
...
<div className="container_desktop">
      <div className="innerContainer_desktop">
        ...
        <div className="cardContainer_desktop">
          <div className="card_desktop" style={{ background: '#F62EFF' }}>
          ...
          <div className="card_desktop" style={{ background: 'rgba(217, 217, 217, 0)' }}>
            <div className="cardText_desktop">
              USDT<br/>
        ...
        <div className="inputContainer_desktop">
          <div className="inputTextContainer_desktop">
            <div className="inputLabelText_desktop">Cashout Amount</div>
            <div className="inputPlaceholderText_desktop">Cashout Amount</div>
          </div>
        </div>
        <div className="inputContainer_desktop">
          <div className="inputTextContainer_desktop">
            <div className="inputLabelText_desktop">Cashout Pin</div>
            <div className="inputPlaceholderText_desktop">Cashout Pin</div>
          </div>
        </div>
