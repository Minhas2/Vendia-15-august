...
// import animationData from '../../1.json'; // Adjust the path as needed

import { MDBCardImage, MDBCardTitle, MDBCardText } from "mdb-react-ui-kit";
import {
  // MDBBtn,
  MDBModal,
  MDBModalDialog,
      ...
      <Button variant="primary" onClick={handleShow2}>
            ...
            >
              <div style={modalStyleM}>
                <div style={headerStyleM}>
                  ...
                  <div style={bodyTextStyleM}>
                    Account balance must be above 100.00 USDT to begin
                    submission.
                  </div>
                </div>
            ...
            >
              <div style={modalStyle2mobile}>
                <div style={headerStyle2mobile}>
                  ...
                  <div style={bodyTextStyle2mobile}>
                    Opening Hours: 10:00:00 - 22:00:00
                  </div>
                </div>
                <div style={reminderContainerStyle2mobile}>
                  ...
                  <div style={reminderTextStyle2mobile}>
                    ...
                    <div style={{ display: "flex", alignItems: "center" }}>
                      <GoDotFill style={iconStyle2mobile} />
                      <span>
                        Products distribution will be paused outside of
                        operating hours.
                      </span>
                    </div>
                  </div>
                ...
                <div style={buttonContainerStyle2mobile}>
                  <Button
                    ...
                    style={confirmButtonStyle2mobile}
                  >
        ...
        <div
          ...
          style={{
            backgroundImage: isMobile
              ? "none"
              : "url('../assets/topbackgroundofws.png')", // Replace with your image path
            backgroundSize: "cover",
            backgroundPosition: "center",
            padding: "10px",
            width: "100%",
          ...
          {isMobile ? (
            <>
              ...
              <div className="row">
                ...
                <div className="col-lg-3 col-md-4 col-sm-2 col-4 order-lg-1 order-md-1 order-sm-1 order-1">
                  <img
                    ...
                    style={{
                      width: "100%",
                      borderRadius: "50%",
                      boxShadow: "rgba(104, 70, 205, 0.5) 1px -4px 30px 30px",
                      marginTop: "20px",
                ...
                <div
                  className="col-lg-3 col-md-4 col-sm-8 col-4 order-lg-2 order-md-2 order-sm-2 order-2"
                  style={{ padding: "10px" }}
                >
                  <div
                    style={{
                ...
                {/* updating it  */}
                <div
                  className="col-lg-3 col-md-4 col-sm-2 col-4 order-lg-4 order-md-3 order-sm-3 order-3"
            ...
            >
              ...
              <div className="col-lg-2 col-md-4 col-sm-4 col-4 order-lg-1 order-md-1 order-sm-1 order-1">
                <img
                  ...
                  style={{
                    ...
                    marginLeft: "45px",
                    marginTop: "50px",
                    boxShadow: "rgba(84, 70, 205, 0.5) 1px -4px 30px 30px",
                    borderRadius: "50%",
                  }} // Styling the image as a circle
                />
              </div>
              ...
              <div
                className="col-lg-4 col-md-4 col-sm-4 col-4 order-lg-2 order-md-2 order-sm-2 order-2 "
              ...
              <div className="col-lg-2 col-md-4 col-sm-4 col-4 order-lg-4 order-md-3 order-sm-3 order-3">
                ...
                <div className="row mb-3">
                  <div
                    ...
                    style={{ alignContent: "center", padding: "0px" }}
                  >
                    <p
                      onClick={handleShow2}
                      style={{
        ...
        <div className="container">
          <MDBRow
            ...
            style={{ padding: isMobile ? "5px" : "150px 150px 0" }}
          >
     ...
     <MDBCard className='h-100' style={{ background: 'linear-gradient(to bottom, #2CF1FA, #FFFFFF)',borderRadius:isMobile?"19.8px":"20px"}}>
      ...
      {isMobile ? (
        <div style={{ width: "100%", justifyContent: "center" }}>
          ...
          <div data-bs-toggle="modal" data-bs-target="#animation1Modal">
      ...
      <div
        ...
        id="animation1Modal"
        tabIndex={-1}
        aria-labelledby="animation1ModalLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div data-bs-toggle="modal" data-bs-target="#lottieModal">
              <dotlottie-player
                src={"/1.json"}
                background="transparent"
                speed="1"
      ...
      {/* <!-- Modal --> animation lottie*/}
      <div
        className="modal fade"
        id="lottieModal"
        tabIndex={-1}
        aria-labelledby="lottieModalLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
