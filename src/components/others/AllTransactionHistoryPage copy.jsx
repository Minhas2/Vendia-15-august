...
<button onClick={handleClick1} style={{width: 91, height: 48, paddingLeft: 24, paddingRight: 24, paddingTop: 21, paddingBottom: 21, background: '#F62EFF', borderRadius: 100, border: '1px white solid', justifyContent: 'center', alignItems: 'center', gap: 2, display: 'flex'}}>
...
<div onClick={handleClick3} style={{width: 97, height: 48, paddingLeft: 24, paddingRight: 24, paddingTop: 21, paddingBottom: 21, background: '#4113A0', borderRadius: 100, border: '1px white solid', justifyContent: 'center', alignItems: 'center', gap: 2, display: 'flex'}}>
...
<div  onClick={handleClick1} style={{flex: '1 1 0', height: 48, paddingLeft: 24, paddingRight: 24, paddingTop: 21, paddingBottom: 21, background: '#F62EFF', borderRadius: 100, border: '1px white solid', justifyContent: 'center', alignItems: 'center', gap: 16, display: 'flex'}}>
...
<div onClick={handleClick3} style={{flex: '1 1 0', height: 48, paddingLeft: 24, paddingRight: 24, paddingTop: 21, paddingBottom: 21, background: '#4113A0', borderRadius: 100, border: '1px white solid', justifyContent: 'center', alignItems: 'center', gap: 16, display: 'flex'}}>
...
<div style={{alignSelf: 'stretch', height: 416, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 13, display: 'flex'}}>
...
<div style={{height: 113, left: 15, top: 7, position: 'absolute', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 6, display: 'inline-flex'}}>
  <div style={{alignSelf: 'stretch', justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex'}}>
    ...
    <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'flex'}}>
      <div style={{color: '#03C876', fontSize: 10, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word'}}>Merged</div>
      <div style={{color: '#FA2C2C', fontSize: 10, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word'}}>Pending</div>
      <div style={{width: 42, height: 15, paddingLeft: 8, paddingRight: 8, paddingTop: 2, paddingBottom: 2, background: '#4113A0', borderRadius: 15, justifyContent: 'center', alignItems: 'center', gap: 10, display: 'flex'}}>
        <div style={{color: 'white', fontSize: 8, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word'}}>Submit</div>
  ...
  <div style={{width: 297, height: 54, justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'inline-flex'}}>
    ...
    <div style={{color: 'black', fontSize: 12, fontFamily: 'Outfit', fontWeight: '600', lineHeight: 1, wordWrap: 'break-word'}}>HP Elitebook, 16GB RAM, 14’ Screen</div>
  </div>
  <div style={{alignSelf: 'stretch', justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex'}}>
    <div style={{width: 64, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 3, display: 'inline-flex'}}>
      <div style={{alignSelf: 'stretch', color: '#4113A0', fontSize: 8, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word', marginTop: '5px',textAlign:"left"}}>Total Amount</div>
      <div style={{alignSelf: 'stretch', color: 'black', fontSize: 10, fontFamily: 'Outfit', fontWeight: '700', wordWrap: 'break-word', marginTop: '-5px',textAlign:"left"}}>USDT 300.00</div>
    </div>
    <div style={{width: 64, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 3, display: 'inline-flex'}}>
      <div style={{alignSelf: 'stretch', color: '#4113A0', fontSize: 8, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word', marginTop: '5px',textAlign:"left"}}>Profit</div>
      <div style={{alignSelf: 'stretch', color: 'black', fontSize: 10, fontFamily: 'Outfit', fontWeight: '700', wordWrap: 'break-word', marginTop: '-5px',textAlign:"left"}}>USDT 10.00</div>
    </div>
  </div>
...
<div style={{height: 113, left: 15, top: 7, position: 'absolute', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 6, display: 'inline-flex'}}>
  <div style={{alignSelf: 'stretch', justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex'}}>
    <div style={{opacity: 0.50, color: 'black', fontSize: 8, fontFamily: 'Outfit', fontWeight: '300', wordWrap: 'break-word'}}>2024/06/08-11:28 am</div>
    <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'flex'}}>
      <div style={{color: '#03C876', fontSize: 10, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word'}}>Completed</div>
      <div style={{width: 297, height: 0, left: 0, top: 17, position: 'absolute', border: '1px rgba(0, 0, 0, 0.10) solid'}}></div>
  ...
  <div style={{width: 297, height: 54, justifyContent: 'flex-start', alignItems: 'center', gap: 4, display: 'inline-flex'}}>
    ...
    <div style={{color: 'black', fontSize: 12, fontFamily: 'Outfit', fontWeight: '600', lineHeight: 1, wordWrap: 'break-word'}}>Samsung Galaxy A55, 4GB RAM, 6.5’ Screen</div>
  </div>
  <div style={{alignSelf: 'stretch', justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex'}}>
    <div style={{width: 64, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 3, display: 'inline-flex'}}>
      <div style={{alignSelf: 'stretch', color: '#4113A0', fontSize: 8, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word', marginTop: '5px',textAlign:"left"}}>Total Amount</div>
...
<div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'flex'}}>
      <div style={{color: '#03C876', fontSize: 15, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word'}}>Merged</div>
      <div style={{color: '#FA2C2C', fontSize: 15, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word'}}>Pending</div>
      <div style={{width: 42, height: 15, paddingLeft: 8, paddingRight: 8, paddingTop: 2, paddingBottom: 2, background: '#4113A0', borderRadius: 15, justifyContent: 'center', alignItems: 'center', gap: 10, display: 'flex'}}>
        <div style={{color: 'white', fontSize: 10, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word'}}>Submit</div>
      </div>
    </div>
</div>
...
gap: '8px'
 ...
 <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 8, display: 'flex'}}>
      <div style={{color: '#03C876', fontSize: 15, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word'}}>Merged</div>
      <div style={{color: '#F77EF9', fontSize: 15, fontFamily: 'Outfit', fontWeight: '500', wordWrap: 'break-word'}}>Frozen</div>
    </div>
</div>
</div>
<div style={{
