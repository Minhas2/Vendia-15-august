...
{isMobile ? (
  <div style={{width: 333, height: 48, paddingLeft: 24, paddingRight: 24, paddingTop: 21, paddingBottom: 21, background: '#F62EFF', borderRadius: 100, border: '1px white solid', justifyContent: 'center', alignItems: 'center', gap: 16, display: 'inline-flex'}}>
    <img style={{width: 24, height: 24}} src="../assets/thl3.png" />
    <div style={{textAlign: 'center', color: 'white', fontSize: 18, fontFamily: 'Outfit', fontWeight: '700', lineHeight: 27, letterSpacing: 0.30, wordWrap: 'break-word'}}>Pending Transactions</div>
  </div>
) : (
...
<MDBCard className='text-center' style={{marginTop:"20px", backgroundColor:"#4113A0", marginLeft:isMobile?"15px":"50px", marginRight:isMobile?"15px":"50px", borderRadius:"20px"}}>
      ...
      <MDBCardBody>
       <MDBRow style={{alignContent:"left", justifyContent:"left"}}>
        <MDBCol md="8"  style={{alignItems:"left", justifyContent:"left", display:"flex"}}>
